...
def model_fruitdata(img_path):
    ...
    if prediction==0:
        prediction="The disease in the leaf was identified as Apple Black Rot. Captna and sulphur products are labeled for control of both scab and black rot. A scab spray program including these chemicals may help prevent the frog-eye leaf spot of black spot, as well as the infection of fruit."
    elif prediction==1:
